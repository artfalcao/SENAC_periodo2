...
# Escreva um trigger para debitar o limite de crédito do cliente após ser inserido uma venda deste cliente.
DELIMITER $$
...
DROP TRIGGER CREDITE_LIM_CLIENTE;

# Escreva um trigger para creditar o limite de crédito do cliente após ser inserido um pagamento de uma venda deste cliente.
DELIMITER $$  
